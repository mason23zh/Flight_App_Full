...
const useMatchedFirFeatures = (controllerInfo: VatsimControllers, firData: VatsimFirs, geoJsonData: GeoJson.FeatureCollection): GeoJson.FeatureCollection => {
    ...
    //                     console.log("Matched controller info:", controller);
    ...
    //                         geoJsonData.features.find(feature => feature.properties.id === mFir.fir);
    //                 if (geoJsonFeature) {
    //                     const isDuplicate =
    //                             newFeatures.some(existingFeature => existingFeature.properties.id === geoJsonFeature.properties.id);
