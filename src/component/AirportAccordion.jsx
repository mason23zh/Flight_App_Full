...
function AirportAccordion({ airport }) {
    ...
    const themeClass = !darkMode
        ? "text-lg p-3 items-center justify-between h-full bg-gray-200 drop-shadow-md mt-2.0 border-2 rounded-xl grid grid-rows-4 grid-cols-none"
            + " airportAccordionSm:grid-cols-3 airportAccordionSm:grid-rows-2"
            + " airportAccordionMd:grid-cols-4 airportAccordionMd:grid-rows-none airportAccordionMd:w-[1080px] "
        : "text-lg p-3 items-center justify-between h-full bg-gray-500 drop-shadow-md mt-2.0 border-2 rounded-xl grid grid-rows-4 grid-cols-none"
            + " airportAccordionSm:grid-cols-3 airportAccordionSm:grid-rows-2"
            + " airportAccordionMd:grid-cols-4 airportAccordionMd:grid-rows-none airportAccordionMd:w-[1080px] ";
    ...
    return (
        <div className="self-stretch">
            <div className={themeClass}>
                ...
                airportAccordionMd:col-start-1 airportAccordionMd:col-end-2 airportAccordionMd:row-span-full"
                >
                ...
                airportAccordionMd:col-start-2 airportAccordionMd:col-end-3 airportAccordionMd:row-span-full"
                >
                ...
                airportAccordionMd:col-start-3 airportAccordionMd:col-end-4 airportAccordionMd:row-span-full "
                >
