            ...
            <div className="grid gird-cols-2 gap-2 text-sm sm:text-lg">
                <div className="hover:border rounded-xl">
                    <div className="grid grid-cols-2 ">
                        ...
                        <div className="text-right sm:text-center">{ICAO}</div>
                    </div>
                </div>
                ...
                <div className="hover:border rounded-xl">
                    <div className="grid grid-cols-2 ">
                        ...
                        <div className="text-right sm:text-center">{iata}</div>
                    </div>
                </div>
                ...
                <div className="hover:border rounded-xl">
                    <div className="grid grid-cols-2 ">
                        ...
                        <div className="text-right sm:text-center">{region}</div>
                    </div>
                </div>
                ...
                <div className="hover:border rounded-xl">
                    <div className="grid grid-cols-2 ">
                        ...
                        <div className="text-right sm:text-center">{country}</div>
                    </div>
                </div>
                ...
                <div className="hover:border rounded-xl">
                    <div className="grid grid-cols-2 ">
                        ...
                        <div className="text-right sm:text-center">{runwayCount}</div>
                    </div>
                </div>
                ...
                <div className="hover:border rounded-xl">
                    <div className="grid grid-cols-2 ">
                        ...
                        <div className="text-right sm:text-center">{elevation} ft</div>
                    </div>
                </div>
                ...
                <div className="hover:border rounded-xl">
                    <div className="grid grid-cols-2 ">
                        ...
                        <div className="text-right sm:text-center">{transitionAltitude} ft</div>
                    </div>
                </div>
                ...
                <div className="hover:border rounded-xl">
                    <div className="grid grid-cols-2 ">
                        ...
                        <div className="text-right sm:text-center">
                            {airportType.includes("_")
                                ? airportType.replace("_", " ")
                                : airportType}
                        </div>
                    </div>
                </div>
