...
function HomeAirportAccordion({ airport }) {
    ...
    const themeClass = !darkMode
        ? "text-lg p-3 items-center h-full bg-gray-200 drop-shadow-md mt-2 border-2 rounded-xl grid grid-cols-1"
        : "text-lg p-3 items-center h-full bg-gray-500 drop-shadow-md mt-2 border-2 rounded-xl grid grid-cols-1";
    ...
    return (
        <div className="">
            <div className={themeClass}>
                <div className="text-center p-2 inline-block ">
