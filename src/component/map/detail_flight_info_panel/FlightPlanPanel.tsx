...
const FlightPlanPanel = ({ flight_plan, depAirport, arrAirport }: FlightPlanPanelProps) => {
    ...
    return (
        <div
            className="bg-gray-500/30 p-3 backdrop-blur-lg 
        text-sm text-white text-center max-w-screen-xl 
        max-h-[400px] mx-auto overflow-y-auto scrollbar
        scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-gray-500"
        >
            <div className="grid grid-rows-1 gap-5 h-auto">
                <div className="grid grid-cols-[min-content_1fr] gap-8 items-start">
                    ...
                    <div className="flex flex-col space-y-1">
                        <div className="text-left">{depAirportName}</div>
                    ...
                    <div className="flex flex-col space-y-1">
                        <div className="text-left">{arrAirportName}</div>
                        <div className="flex justify-end space-x-1 text-xs text-gray-300">
                    ...
                    <div className="text-left text-sm">{route}</div>
                </div>
            </div>
        </div>
    );
