...
const ControllerPopupContent = ({ serviceData, serviceType }: Props) => {
    ...
    const renderedService = (serviceData: Service, serviceType: string) => {
        ...
        if (serviceType === "GND") {
            ...
            serviceIcon = (
                <div
                    className="bg-blue-500 rounded-md text-white px-1 py-0
            ...
            serviceIcon = (
                <div className="grid grid-cols-1 justify-center items-center">
                    <div className="bg-yellow-600 text-white p-1 w-[40px] text-center ">ATIS</div>
        ...
        const { hour, minute } = returnOnlineTime(serviceData.logon_time);
        ...
        if (serviceType !== "ATIS") {
            return (
                <div className="grid grid-cols-4 w-full font-bold p-1 sm:p-2">
                    {serviceIcon}
                    <div className="justify-self-start">{serviceData.callsign}</div>
            ...
            return (
                <div className="grid grid-cols-4 w-full border-1 font-bold p-1 sm:p-2">
                    <div className="col-span-1">{serviceIcon}</div>
    ...
    return renderedService(serviceData, serviceType);
};
