            ...
            <table className="text-sm w-full mt-2 mb-2">
                <tbody>
                    <tr className="border text-left">
                        <td className="border p-3">ICAO</td>
                        <td className="p-3">{ICAO}</td>
                    </tr>
                    <tr className="border text-left">
                        <td className="border p-3 ">IATA</td>
                        <td className="p-3">{iata}</td>
                    </tr>
                    <tr className="border text-left">
                        <td className="border p-3">Region</td>
                    ...
                    <tr className="border text-left">
                        <td className="border p-3">Number of runways</td>
                        <td className="p-3">{runwayCount}</td>
                    </tr>
                    <tr className="border text-left">
                        <td className="border p-3">Elevation</td>
                        <td className="p-3">{elevation} ft</td>
                    </tr>
                    <tr className="border text-left">
                        <td className="border p-3">Transition Altitude</td>
                    ...
                    <tr className="border text-left">
                        <td className="border p-3">Coordinates</td>
                        <td className="p-3">{lat}, {lng}</td>
                    </tr>
                    <tr className="border text-left">
                        <td className="border p-3">Home Page</td>
                        <td className="p-3"><a href={homeLink} target="_blank" rel="noreferrer">{ICAO} Home Page</a>
                        </td>
                    </tr>
                    <tr className="border text-left">
                        <td className="border p-3">Wikipedia Page</td>
